...
```yml
# Site settings
title: Sebastian Sonne            # title of your website
SEOTitle: Sebastian Sonne          # check out docs for more detail
description: "Persinal Website"    # ...

# SNS settings      
github_username: sebastian-sonne     # modify this account to yours
